...
(function (root, factory) {
  ...
  var module$contents$Blockly$Python_Python =
    new $.module$exports$Blockly$Generator.Generator("Python");
  ...
  module$contents$Blockly$Python_Python.ORDER_OVERRIDES = [
    [
      module$contents$Blockly$Python_Python.ORDER_FUNCTION_CALL,
      module$contents$Blockly$Python_Python.ORDER_MEMBER,
    ],
    [
      module$contents$Blockly$Python_Python.ORDER_FUNCTION_CALL,
      module$contents$Blockly$Python_Python.ORDER_FUNCTION_CALL,
    ...
    [
      module$contents$Blockly$Python_Python.ORDER_LOGICAL_AND,
      module$contents$Blockly$Python_Python.ORDER_LOGICAL_AND,
    ],
    [
      module$contents$Blockly$Python_Python.ORDER_LOGICAL_OR,
      module$contents$Blockly$Python_Python.ORDER_LOGICAL_OR,
    ],
  ];
  ...
  module$contents$Blockly$Python_Python.init = function (a) {
    ...
    this.nameDB_
      ? this.nameDB_.reset()
      : (this.nameDB_ = new $.module$exports$Blockly$Names.Names(
    ...
    for (
      var b = [],
        c = (0, $.module$exports$Blockly$Variables.allDeveloperVariables)(a),
        d = 0;
      d < c.length;
      d++
    )
    ...
    for (c = 0; c < a.length; c++)
      b.push(
        this.nameDB_.getName(
          a[c].getId(),
          $.module$exports$Blockly$Names.NameType.VARIABLE
        ) + " = None"
      );
  ...
  module$contents$Blockly$Python_Python.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
      ...
      e &&
        ((e = (0, $.module$exports$Blockly$utils$string.wrap)(
          e,
          this.COMMENT_WRAP - 3
        )),
      ...
      for (var f = 0; f < a.inputList.length; f++)
        a.inputList[f].type ===
          $.module$exports$Blockly$inputTypes.inputTypes.VALUE &&
  ...
  module$contents$Blockly$Python_Python.getAdjustedInt = function (a, b, c, d) {
    ...
    (0, $.module$exports$Blockly$utils$string.isNumber)(a)
  ...
  var module$contents$Blockly$Python$texts_strRegExp = /^\s*'([^']|\\')*'\s*$/,
    module$contents$Blockly$Python$texts_forceString = function (a) {
      return module$contents$Blockly$Python$texts_strRegExp.test(a)
        ? [a, $.Blockly.Python.ORDER_ATOMIC]
    ...
    switch (a.itemCount_) {
      ...
      case 1:
        return (
          ...
          module$contents$Blockly$Python$texts_forceString(a)
        );
      case 2:
        var b =
          $.Blockly.Python.valueToCode(
        ...
        return [
          module$contents$Blockly$Python$texts_forceString(b)[0] +
            " + " +
            module$contents$Blockly$Python$texts_forceString(a)[0],
          $.Blockly.Python.ORDER_ADDITIVE,
        ];
      default:
        b = [];
        ...
        a = $.Blockly.Python.nameDB_.getDistinctName(
          "x",
          $.module$exports$Blockly$Names.NameType.VARIABLE
        );
        return [
          "''.join([str(" + a + ") for " + a + " in [" + b.join(", ") + "]])",
          $.Blockly.Python.ORDER_FUNCTION_CALL,
        ];
    }
  };
  $.Blockly.Python.text_append = function (a) {
    var b = $.Blockly.Python.nameDB_.getName(
      a.getFieldValue("VAR"),
      $.module$exports$Blockly$Names.NameType.VARIABLE
    );
    a =
  ...
  $.Blockly.Python.text_getSubstring = function (a) {
    ...
    switch (c) {
      ...
      case "FROM_END":
        ...
        (0, $.module$exports$Blockly$utils$string.isNumber)(String(a))
          ? 0 === a && (a = "")
  ...
  $.Blockly.Python.text_count = function (a) {
    var b =
      ...
      "''";
    a =
      $.Blockly.Python.valueToCode(a, "SUB", $.Blockly.Python.ORDER_NONE) ||
      "''";
  ...
  $.Blockly.Python.procedures_defreturn = function (a) {
    for (
      var b = [],
        c = a.workspace,
        d = (0, $.module$exports$Blockly$Variables.allUsedVarModels)(c) || [],
        e = 0,
        f;
      (f = d[e]);
      e++
    ...
    c = b.length
      ? $.Blockly.Python.INDENT + "global " + b.join(", ") + "\n"
      : "";
    b = $.Blockly.Python.nameDB_.getName(
      a.getFieldValue("NAME"),
      $.module$exports$Blockly$Names.NameType.PROCEDURE
    );
    d = "";
    $.Blockly.Python.STATEMENT_PREFIX &&
      (d += $.Blockly.Python.injectId($.Blockly.Python.STATEMENT_PREFIX, a));
    $.Blockly.Python.STATEMENT_SUFFIX &&
      (d += $.Blockly.Python.injectId($.Blockly.Python.STATEMENT_SUFFIX, a));
    d && (d = $.Blockly.Python.prefixLines(d, $.Blockly.Python.INDENT));
    e = "";
    $.Blockly.Python.INFINITE_LOOP_TRAP &&
      (e = $.Blockly.Python.prefixLines(
    ...
    for (var k = [], l = a.getVars(), m = 0; m < l.length; m++)
      k[m] = $.Blockly.Python.nameDB_.getName(
        l[m],
        $.module$exports$Blockly$Names.NameType.VARIABLE
      );
    c = "def " + b + "(" + k.join(", ") + "):\n" + c + d + e + f + h + g;
  ...
  $.Blockly.Python.math_change = function (a) {
    ...
    a = $.Blockly.Python.nameDB_.getName(
      a.getFieldValue("VAR"),
      $.module$exports$Blockly$Names.NameType.VARIABLE
    );
    return (
    ...
    switch (b) {
      ...
      case "MEDIAN":
        $.Blockly.Python.definitions_.from_numbers_import_Number =
          "from numbers import Number";
        b =
          $.Blockly.Python.provideFunction_("math_median", [
            "def " + $.Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + "(myList):",
      ...
      case "MODE":
        b =
          $.Blockly.Python.provideFunction_("math_modes", [
            "def " +
      ...
      case "STD_DEV":
        $.Blockly.Python.definitions_.import_math = "import math";
        b =
          $.Blockly.Python.provideFunction_("math_standard_deviation", [
  ...
  $.Blockly.Python.math_constrain = function (a) {
    var b =
        ...
        "0",
      c =
        $.Blockly.Python.valueToCode(a, "LOW", $.Blockly.Python.ORDER_NONE) ||
        "0";
    a =
  ...
  $.Blockly.Python.math_random_int = function (a) {
    ...
    var b =
      ...
      "0";
    a =
      $.Blockly.Python.valueToCode(a, "TO", $.Blockly.Python.ORDER_NONE) || "0";
    return [
      "random.randint(" + b + ", " + a + ")",
      $.Blockly.Python.ORDER_FUNCTION_CALL,
    ];
  ...
  $.Blockly.Python.math_atan2 = function (a) {
    ...
    return [
      "math.atan2(" +
        ($.Blockly.Python.valueToCode(a, "Y", $.Blockly.Python.ORDER_NONE) ||
          "0") +
        ", " +
        b +
        ") / math.pi * 180",
  ...
  $.Blockly.Python.controls_repeat_ext = function (a) {
    var b = a.getField("TIMES")
      ...
      : $.Blockly.Python.valueToCode(a, "TIMES", $.Blockly.Python.ORDER_NONE) ||
        "0";
    b = (0, $.module$exports$Blockly$utils$string.isNumber)(b)
      ? parseInt(b, 10)
      : "int(" + b + ")";
    ...
    return (
      "for " +
      $.Blockly.Python.nameDB_.getDistinctName(
        "count",
        $.module$exports$Blockly$Names.NameType.VARIABLE
      ) +
      " in range(" +
  ...
  $.Blockly.Python.controls_for = function (a) {
    var b = $.Blockly.Python.nameDB_.getName(
      ...
      d =
        ...
        "0",
      e =
        $.Blockly.Python.valueToCode(a, "BY", $.Blockly.Python.ORDER_NONE) ||
        "1",
    ...
    if (
      (0, $.module$exports$Blockly$utils$string.isNumber)(c) &&
      (0, $.module$exports$Blockly$utils$string.isNumber)(d) &&
      ...
      var k = function (l, m) {
        (0, $.module$exports$Blockly$utils$string.isNumber)(l)
          ...
          : l.match(/^\w+$/)
          ? (l = "float(" + l + ")")
          : ((m = $.Blockly.Python.nameDB_.getDistinctName(
              b + m,
              $.module$exports$Blockly$Names.NameType.VARIABLE
            )),
            (g += m + " = float(" + l + ")\n"),
  ...
  $.Blockly.Python.controls_if = function (a) {
    ...
    if (a.getInput("ELSE") || $.Blockly.Python.STATEMENT_SUFFIX)
      (e =
        $.Blockly.Python.statementToCode(a, "ELSE") || $.Blockly.Python.PASS),
        $.Blockly.Python.STATEMENT_SUFFIX &&
          (e =
            $.Blockly.Python.prefixLines(
              $.Blockly.Python.injectId($.Blockly.Python.STATEMENT_SUFFIX, a),
  ...
  $.Blockly.Python.lists_indexOf = function (a) {
    ...
    return "FIRST" === a.getFieldValue("END")
      ? [
      ...
      case "RANDOM":
        ...
        b.match(/^\w+$/)
          ...
          : ((a = $.Blockly.Python.nameDB_.getDistinctName(
            ...
            (b = a),
            (a = d));
        d = $.Blockly.Python.nameDB_.getDistinctName(
          "tmp_x",
          $.module$exports$Blockly$Names.NameType.VARIABLE
        );
  ...
  $.Blockly.Python.colour_rgb = function (a) {
    var b = $.Blockly.Python.provideFunction_("colour_rgb", [
      ...
      c =
        $.Blockly.Python.valueToCode(a, "RED", $.Blockly.Python.ORDER_NONE) ||
        0,
      d =
        $.Blockly.Python.valueToCode(a, "GREEN", $.Blockly.Python.ORDER_NONE) ||
        0;
    a =
      $.Blockly.Python.valueToCode(a, "BLUE", $.Blockly.Python.ORDER_NONE) || 0;
    return [
      b + "(" + c + ", " + d + ", " + a + ")",
      $.Blockly.Python.ORDER_FUNCTION_CALL,
    ];
  ...
  $.Blockly.Python.colour_blend = function (a) {
    ...
    a =
      $.Blockly.Python.valueToCode(a, "RATIO", $.Blockly.Python.ORDER_NONE) ||
      0;
    return [
      b + "(" + c + ", " + d + ", " + a + ")",
      $.Blockly.Python.ORDER_FUNCTION_CALL,
